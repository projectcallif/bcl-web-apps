...
<template>
  <div class="flex flex-col gap-6">
    ...
    <!-- Filters -->
    <div
      class="flex flex-col sm:flex-row items-center gap-4 bg-white p-4 rounded-2xl border border-slate-100 shadow-sm shadow-slate-200/50"
    >
    ...
    <div
      ...
      class="flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-dashed border-slate-200"
    >
      <div
      ...
      <p class="text-xs text-slate-400 mt-1">
        Start by creating your first lending product.
      </p>
    </div>
        ...
        <div class="grid grid-cols-2 gap-4 mb-6 pt-6 border-t border-slate-50">
          ...
          <div>
            ...
            <p class="font-bold text-slate-700">
              ...
              <span class="text-[10px] opacity-60">/ mo</span>
            </p>
          </div>
          <div>
            <p
            ...
            <p class="font-bold text-slate-700">
              {{ product.activeTenorCount }} Active
            </p>
          </div>
          <div>
            <p
            ...
            <p class="font-bold text-slate-700">
              {{ product.maxTenor }} {{ product.tenorUnit.toLowerCase() }}
            </p>
          </div>
        </div>
    ...
    >
      ...
      <div class="text-xs text-indigo-700 leading-relaxed">
        <p class="font-bold mb-1 uppercase tracking-wider">
          Product Logic Rule
        </p>
        <p>
          If a product has active tenors defined, only those values will be
          available during application. If no tenors exist, the system falls
          back to the top-level min/max range and interest rate.
        </p>
      </div>
    </div>
  </div>
